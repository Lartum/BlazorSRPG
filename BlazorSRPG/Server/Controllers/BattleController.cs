...
namespace BlazorSRPG.Server.Controllers
{
    ...
    public class BattleController : ControllerBase
    {
        ...
        private async Task Fight(User attacker, User opponent, BattleResult result)
        {
            ...
            result.RoundFought = currentRound;

            if (result.RoundFought > 0)
        ...
        private async Task FinishFight(User attacker, User opponent, 
            BattleResult result, int attackerDamageSum, int opponentDamageSum)
        {
        ...
        private void StoreBattleHistory(User attacker, User opponent, BattleResult result)
        {
            ...
            battle.RoundsFought = result.RoundFought;
